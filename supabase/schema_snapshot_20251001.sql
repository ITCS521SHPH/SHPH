...
-- ========================================
-- APPOINTMENT SCHEDULER & NOTIFICATION ENHANCEMENT
-- ========================================
...
BEGIN
  ...
  PERFORM public.send_appointment_notification(
    NEW.id,
    'appointment_created',
    'New Appointment Scheduled',
    'Your appointment with Dr. ' || v_doctor_name || 
    ' is scheduled for ' || TO_CHAR(NEW.scheduled_date, 'Mon DD, YYYY') ||
    ' at ' || TO_CHAR(NEW.scheduled_time, 'HH12:MI AM')
  );
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'APPOINTMENT SCHEDULER & NOTIFICATIONS READY';
  RAISE NOTICE '========================================';
  RAISE NOTICE '✓ Duration & color categories added';
  RAISE NOTICE '✓ Conflict detection function created';
  RAISE NOTICE '✓ Notification system active';
  RAISE NOTICE '✓ Appointment trigger setup complete';
  RAISE NOTICE '========================================';
END $$;
